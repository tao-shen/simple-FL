"""
Methods module for Simple-FL

This module contains all federated learning algorithm implementations.
The algorithms are dynamically loaded based on the method name.
"""
...
def fl_methods(server, clients, args):
    """
    Factory function to create FL algorithm instance
    
    Args:
        server: Server instance
        clients: List of client instances
        args: Arguments containing method configuration
        
    Returns:
        FL algorithm instance
    """
    return methods[args.method](server, clients, args)


# Alternative static imports (commented out, kept for reference)
# from .fl import *
